...
The goal of `qtalrkit` is to provide supporting resources for the book ["An Introduction to Quantitative Text Analysis for Linguistics: Reproducible Research using R"](https://qtalr.github.io/book/).
