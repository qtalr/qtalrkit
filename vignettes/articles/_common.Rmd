...
write_bib(c(
  ...
  "ggplot2", "gridExtra", "reprex", "rvest", "fs", "purrr", "fontawesome", "webexercises", "corpora", "knitr", "kableExtra", "stringr", "tidyr", "regexplain", "gutenbergr", "word2vec", "wordVectors", "PsychWordVec"
), "packages.bib")
