...
write_bib(c(
  ...
  "ggplot2", "gridExtra", "reprex", "rvest", "fs", "purrr", "fontawesome", "webexercises", "corpora", "knitr", "kableExtra", "stringr", "tidyr", "regexplain", "gutenbergr" # nolint: line_length_linter.
), "packages.bib")
