...
read_rds("assets/listings/data_repositories.rds") |>
  kable(caption = "Data repositories")
```
...
read_rds("assets/listings/data_listings.rds") |> 
  kable(caption = "Aggregated listings of language corpora and datasets")
```
...
read_rds("assets/listings/data_apis.rds") |> 
  kable(caption = "R Package APIs to language corpora and datasets.)")
```
...
read_rds("assets/listings/data_experimental.rds") |> 
  kable(caption = "Other language resources")
```
