---
title: "4. Scaffolding a research project"
...
In Lab 4, we will apply what we have learned in this recipe to scaffold our own research project by forking, cloning, editing, commiting, and pushing a repository to GitHub.

## Concepts and strategies

### Understanding components of a reproducible project

Reproducible projects are composed of two main components: the computing environment and the project structure. The computing environment is the hardware, operating system, and software that we use to do our work and the project structure is the organization of the files and folders that make up our project. As we can see in Figure \@ref(fig:nested-project), each of these components and subcomponents are nested within each other.

<!-- Insert graphic with nested boxes: hardware, operating system, software, R packages, project structure -->

```{r nested-project, fig.cap = "Components of a reproducible project", out.width = "50%", fig.align = "center"}
knitr::include_graphics("assets/images/recipe-4/nested-project.drawio.png")
```

In the lesson on the computing environment, we learned about the importance of understanding the computing environment and how to find out information about our computing environment inspecting an R session, as we see below.
...
As we learned, when the computing environment that is used to create a project is different from the computing environment that is used to reproduce the project, there is a risk that the project will not be reproducible. We will not tackle all the components in Figure \@ref(fig:nested-project) at once, however, but instead we will focus here on the project structure. Later on, with more experience, we will address the other components.

### Approaching reproducible project management
...
### Leveraging Git and GitHub for reproducible project management
...
Verify that you have a working version of Git on your computing environment and make sure that you have a GitHub account. You can refer to [Guide 2](guide-2.html) for more information on how to do this.
:::
...
In Figure \@ref(fig:github-features), I provide a schematic look at the relationship between Github and Git for three common scenarios. 

```{r github-features, fig.cap = "Key features of GitHub", out.width = "100%", fig.align = "center"}
knitr::include_graphics("assets/images/recipe-4/github-features-drawio.png")
```
...
Before beginning the lab, make sure that you are comfortable with the following:
