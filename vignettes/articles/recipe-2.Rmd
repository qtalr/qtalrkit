...
The dataset that we will read into our R session based on the Brown Corpus [@Francis1961]. I've created a data origin file that contains the data documentation for the Brown Corpus, as we can see in Table \@ref(tab:brow-passives-do).

```{r brow-passives-do, echo=FALSE, message=FALSE}
...
The data dictionary which describes the dataset we will read appears in Table \@ref(tab:brow-passives-dd).

```{r brow-passives-dd, echo=FALSE, message=FALSE}
