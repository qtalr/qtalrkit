...
Prerequisites: It will be assumed that learners can create a Quarto document in RStudio, have a basic understanding of R and using R in RStudio editor and console, and have a basic understanding of vectors and datasetsframes and assigning objects to variables.
-->
...
- Write the datasets to different file formats
  - `write_csv()`
  - `write_tsv()`
  - `write_delim()`
-->
