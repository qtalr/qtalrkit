...
We now turn to applying our conceptual knowledge and our technical skills to accomplish the tasks of the data science workflow. In this recipe, we will focus on acquiring data for a text analysis project. 
...
- Best to look for data sources with a research question in mind
  - But finding data first can also be a good way to generate research questions
- Point to the Guide
- Point out that identifying data sources can be time consuming and lead to dead ends
- Point out that the data source should be documented in the data origin file
- Consider permissions and licensing early, to avoid surprises later
- Consider the data format and how it will be used in the analysis
...
Let's now turn to the data collection strategy. We will load the `tidyverse` and `gutenbergr` packages to prepare for the data collection process.
